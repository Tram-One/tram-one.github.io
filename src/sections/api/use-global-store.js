		...
		<section>
			...
			<section-container>
				<section-text>
					...
					<br /><br />
					useGlobalStore takes in a key and an optional default value. The key can be any string, and is used to access
					the value anywhere else in the app. The default value is optional and can be filled in by another call to
					useGlobalStore in the app.
				</section-text>
				<code-block> ${globalStore} </code-block>
			</section-container>
		</section>
	`;
};
